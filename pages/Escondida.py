...
#FLATLY
register_page(__name__, path="/Escondida")
...
layout = html.Div([
    ...
    dbc.Button('Buscar', id='btn-buscar1-e', n_clicks=0, className='btn btn-danger btn-sm mb-2 mt-1'),

 

    html.Div([
        dcc.Graph(id='graph-contentC-e',
                style={'font-family': 'Calibri'}),
        dcc.Graph(id='graph-contentC2-e',
                style={'font-family': 'Calibri'}), 
        dcc.Graph(id='graph-contentC3-e',
                style={'font-family': 'Calibri'}), 
        dcc.Graph(id='graph-contentC4-e',
                style={'font-family': 'Calibri'}),
        # dcc.Graph(id='graph-contentC5-e',
        #         style={'font-family': 'Calibri'}),
        dcc.Graph(id='graph-contentC8-e',
                style={'font-family': 'Calibri'}),  
        dcc.Graph(id='graph-contentC6-e',
                style={'font-family': 'Calibri'}),
        dcc.Graph(id='graph-contentC7-e',
                style={'font-family': 'Calibri'}),
        dcc.Graph(id='graph-contentC9-e',
                style={'font-family': 'Calibri'}),
        # dcc.Graph(id='graph-contentC10-e',
        #         style={'font-family': 'Calibri'}),  
        dcc.Graph(id='graph-contentC11-e',
                style={'font-family': 'Calibri'}),
        # dcc.Graph(id='graph-contentC12-e',
        #         style={'font-family': 'Calibri'}),
        dcc.Graph(id='graph-contentC13-e',
                style={'font-family': 'Calibri'}),
        dcc.Graph(id='graph-contentC14-e',
                style={'font-family': 'Calibri'}), 
        dcc.Graph(id='graph-contentC15-e',
                style={'font-family': 'Calibri'}),
        dcc.Graph(id='graph-contentC16-e',
                style={'font-family': 'Calibri'}),
        # dcc.Graph(id='graph-contentC17-e',
        #         style={'font-family': 'Calibri'}),
        dcc.Graph(id='graph-contentC18-e',
                style={'font-family': 'Calibri'}),
        dcc.Graph(id='graph-contentC19-e',
                style={'font-family': 'Calibri'}),
        dcc.Graph(id='graph-contentC20-e',
                style={'font-family': 'Calibri'}),
        dcc.Graph(id='graph-contentC21-e',
                style={'font-family': 'Calibri'}),
        dcc.Graph(id='graph-contentC22-e',
                style={'font-family': 'Calibri'}), 
        dcc.Graph(id='graph-contentC23-e',
                style={'font-family': 'Calibri'}), 
        dcc.Graph(id='graph-contentC24-e',
                style={'font-family': 'Calibri'}),
        dcc.Graph(id='graph-contentC25-e',
                style={'font-family': 'Calibri'}),
        dcc.Graph(id='graph-contentC26-e',
                style={'font-family': 'Calibri'}),  
        dcc.Graph(id='graph-contentC27-e',
                style={'font-family': 'Calibri'}),
        dcc.Graph(id='graph-contentC28-e',
                style={'font-family': 'Calibri'}),
        dcc.Graph(id='graph-contentC29-e',
                style={'font-family': 'Calibri'}),
        dcc.Graph(id='graph-contentC30-e',
                style={'font-family': 'Calibri'}),
        dcc.Graph(id='graph-contentC31-e',
                style={'font-family': 'Calibri'}),
        dcc.Graph(id='graph-contentC32-e',
                style={'font-family': 'Calibri'}), 
        dcc.Graph(id='graph-contentC33-e',
                style={'font-family': 'Calibri'}), 
        dcc.Graph(id='graph-contentC34-e',
                style={'font-family': 'Calibri'}),
        dcc.Graph(id='graph-contentC35-e',
                style={'font-family': 'Calibri'}),
        dcc.Graph(id='graph-contentC36-e',
                style={'font-family': 'Calibri'}),  
        dcc.Graph(id='graph-contentC37-e',
                style={'font-family': 'Calibri'}),
        dcc.Graph(id='graph-contentC38-e',
                style={'font-family': 'Calibri'}),
        dcc.Graph(id='graph-contentC39-e',
                style={'font-family': 'Calibri'}),
        # dcc.Graph(id='graph-contentC40-e',
        #         style={'font-family': 'Calibri'}),
        dcc.Graph(id='graph-contentC41-e',
                style={'font-family': 'Calibri'}),
        dcc.Graph(id='graph-contentC42-e',
                style={'font-family': 'Calibri'}), 
        dcc.Graph(id='graph-contentC43-e',
                style={'font-family': 'Calibri'}), 
        dcc.Graph(id='graph-contentC44-e',
                style={'font-family': 'Calibri'}),
        dcc.Graph(id='graph-contentC45-e',
                style={'font-family': 'Calibri'}),
        dcc.Graph(id='graph-contentC46-e',
                style={'font-family': 'Calibri'}),
        dcc.Graph(id='graph-contentC47-e',
                style={'font-family': 'Calibri'}),
        dcc.Graph(id='graph-contentC48-e',
                style={'font-family': 'Calibri'}),
...
def perform_database_queries(start_date, end_date,selected_poligonos,option_selected,datetime_option):
    ...
    if ((option_selected == 'PLMN') and (datetime_option == 'DAY')):
        ...
        if selected_poligonos is not None:
            ...
            q=db.query_PLMN_2(start_date, end_date)
        ...
        if selected_poligonos is not None:
            ...
            q=db.query_PLMN_H_2(start_date, end_date)
            df= db.getdata_recursive(q,Folder_out+'\\'+ "q",'update', ' ', 'MySQL', 'DSN=BHP')
    ...
    elif ((option_selected == 'Celdas') and (datetime_option == 'DAY')):
        ...
        if selected_poligonos is not None:
            ...
            q=db.query_cell_2(start_date, end_date,celdas_L)
            df= db.getdata_recursive(q,Folder_out+'\\'+ "q",'update', ' ', 'MySQL', 'DSN=BHP')
        ...
        if selected_poligonos is not None:
            ...
            q=db.query_cell_H_2(start_date, end_date,celdas_L)
            df= db.getdata_recursive(q,Folder_out+'\\'+ "q",'update', ' ', 'MySQL', 'DSN=BHP')
            df['date_id'] = pd.to_datetime(df['date_id'], format='%Y-%m-%d')
            df['hour_id'] = pd.to_timedelta(df['hour_id'], unit='h')
            df['date_id'] = df['date_id'] + df['hour_id']
    ...
    elif ((option_selected == 'Sitios') and (datetime_option == 'DAY')):
        df_cell_filtro = df_cell[df_cell['lnbts_name'].isin(selected_poligonos)]
        ...
        if selected_poligonos is not None:
            ...
            q=db.query_sitio_2(start_date, end_date,celdas_L)
            df= db.getdata_recursive(q,Folder_out+'\\'+ "q",'update', ' ', 'MySQL', 'DSN=BHP')


    elif ((option_selected == 'Sitios') and (datetime_option == 'HOUR')):
        df_cell_filtro = df_cell[df_cell['lnbts_name'].isin(selected_poligonos)]
        ...
        if selected_poligonos is not None:
            ...
            q=db.query_sitio_H_2(start_date, end_date,celdas_L)
            df= db.getdata_recursive(q,Folder_out+'\\'+ "q",'update', ' ', 'MySQL', 'DSN=BHP')
            df= db.getdata_recursive(q,Folder_out+'\\'+ "q",'update', ' ', 'MySQL', 'DSN=BHP')
            df['date_id'] = pd.to_datetime(df['date_id'], format='%Y-%m-%d')
            df['hour_id'] = pd.to_timedelta(df['hour_id'], unit='h')
...
@callback(
    [Output('PLMN-dropdown1-e', 'style'),
     Output('Sitios-dropdown1-e', 'style'),
     Output('Celdas-dropdown1-e', 'style'),
     Output('dropdown-sectorC-e', 'style')],
    [Input('poligonos-sitios-radio1-e', 'value')]
)
...
# Definir la función de actualización del gráfico
@callback(
    [Output('graph-contentC-e', 'figure'),
     Output('graph-contentC2-e','figure'),
     Output('graph-contentC3-e','figure'),
     Output('graph-contentC4-e','figure'),
     #Output('graph-contentC5-e','figure'),
     Output('graph-contentC6-e','figure'),
     Output('graph-contentC7-e','figure'),
     Output('graph-contentC8-e','figure'),
     Output('graph-contentC9-e','figure'),
     #Output('graph-contentC10-e','figure'),
     Output('graph-contentC11-e','figure'),
     #Output('graph-contentC12-e','figure'),
     Output('graph-contentC13-e','figure'),
     Output('graph-contentC14-e','figure'),
     Output('graph-contentC15-e','figure'),
     Output('graph-contentC16-e','figure'),
     #Output('graph-contentC17-e','figure'),
     Output('graph-contentC18-e','figure'),
     Output('graph-contentC19-e','figure'),
     Output('graph-contentC20-e','figure'),
     Output('graph-contentC21-e','figure'),
     Output('graph-contentC22-e','figure'),
     Output('graph-contentC23-e','figure'),
     Output('graph-contentC24-e','figure'),
     Output('graph-contentC25-e','figure'),
     Output('graph-contentC26-e','figure'),
     Output('graph-contentC27-e','figure'),
     Output('graph-contentC28-e','figure'),
     Output('graph-contentC29-e','figure'),
     Output('graph-contentC30-e','figure'),
     Output('graph-contentC31-e','figure'),
     Output('graph-contentC32-e','figure'),
     Output('graph-contentC33-e','figure'),
     Output('graph-contentC34-e','figure'),
     Output('graph-contentC35-e','figure'),
     Output('graph-contentC36-e','figure'),
     Output('graph-contentC37-e','figure'),
     Output('graph-contentC38-e','figure'),
     Output('graph-contentC39-e','figure'),
     #Output('graph-contentC40-e','figure'),
     Output('graph-contentC41-e','figure'),
     Output('graph-contentC42-e','figure'),
     Output('graph-contentC43-e','figure'),
     Output('graph-contentC44-e','figure'),
     Output('graph-contentC45-e','figure'),
     Output('graph-contentC46-e','figure'),
     Output('graph-contentC47-e','figure'),
     Output('graph-contentC48-e','figure'),
     Output('dropdown-sectorC-e', 'options'),
     Output('dropdown-sectorC-e', 'value'),
     #Output('dropdown-sectorC-e', 'style'),
     Output('graph-contentC11-e','style'),
     Output('graph-contentC37-e','style'),
     Output('graph-contentC46-e','style'),
     Output('graph-contentC36-e','style')],
    [Input('btn-buscar1-e', 'n_clicks')],
    [State('date-range-picker1-e', 'start_date'),
     State('date-range-picker1-e', 'end_date'),
     State('PLMN-dropdown1-e', 'value'),
     State('Sitios-dropdown1-e', 'value'),
     State('Celdas-dropdown1-e', 'value'),  # Nuevo input para sitios
     State('poligonos-sitios-radio1-e', 'value'),
     State('time-radio1-e', 'value'),
     State('dropdown-sectorC-e', 'value'),  # Nuevo input para el dropdown
     Input('dropdown-sectorC-e', 'value')]
)
def update_graph(n_clicks, start_date, end_date,selected_poligonos_dropdown, selected_sitios_input,selected_celdas_input, option_selected,datetime_option,selected_cell,select_cell_value):
    ...
    if  (triggered_component_id == 'btn-buscar1-e' and selected_poligonos_dropdown) or (triggered_component_id == 'btn-buscar1-e' and selected_sitios_input) or (triggered_component_id == 'btn-buscar1-e' and selected_celdas_input):
        

        print('Escondida:',datetime.now())
        if option_selected == 'PLMN':
